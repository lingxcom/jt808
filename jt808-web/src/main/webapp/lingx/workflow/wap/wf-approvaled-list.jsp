...
$(function(){
	...
	$(function(){
		$.post(handlerJspWf,{c:"getWorkflowListByXG"},function(json){
			model.list=json;
		},"json");
	});
});
...
<header id="default_header" class="mui-bar mui-bar-nav" style="background-color:#5b8dca;">
			...
			<h1 class="mui-title" style="color:#fff;">审批历史</h1>
</header>
        ...
        <li class="mui-table-view-cell m-table-view-cell" ms-repeat="list" ms-click="handler(el.id)">
             <div class="mui-table">
                <div class="mui-table-cell mui-col-xs-12">
                    ...
                    <p class="mui-h6 fs14 mui-ellipsis fc-yellow">办理节点：{{el.name}}</p>
                </div>
            </div>
        </li>
