    ...
    Ext.onReady(function() {
        ...
        var viewport = Ext.create('Ext.Viewport', {
                ...
                items:{
                	...
                	items: [
                	        ...
                	        {text:'保存表单',
                	        	handler:function(){
                	        		$("#ueditor_0").contents().find(".lingx-wf").css("border","1px solid #a9a9a9");
                	        		$.post(handlerJsp,{c:"saveForm",id:formId,content:ue.getContent()},function(json){
            ...
            { region: 'center',
            	title:"表单图",
            	autoScroll:true,
            	html:"<script id='editor' type='text/plain' style='width:1024px;height:500px;overflow:auto;'></script>"
            	,listeners:{
                ...
                listeners:{
                	propertychange:function(source,recordId,value,oldValue,eOpts){
                		//$("#ueditor_0").contents()
                		lgxInfo("操作成功"+recordId);
                		$("#ueditor_0").contents().find("#"+inputId).attr(recordId,value);
                	}
                }
            }]
        });
