                ...
                items:{
                	...
                	items: [
                	        ...
                	        {text:'保存表单',
                	        	...
                	        	handler:function(){
                	        		$("#ueditor_0").contents().find(".lingx-wf").css("border","1px solid #a9a9a9");
                	        		$.post(handlerJsp,{c:"saveForm3",id:formId,content:LE.getContent()},function(json){
                ...
                listeners:{
                	select:function(view,record,item,index,event,obj){
                		if(formId){
                			...
                			Lingx.post(handlerJsp,{c:"getForm3",id:formId},function(json){
