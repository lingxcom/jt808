...
function uploadPackage(){
	openWindow("上传更新","lingx/model/update/download_step2.jsp");
}
...
<div class="row">
<div class="col-md-6">
说明：目前更新操作不可回退，更新前请做好备份。由于安装是相互覆盖的过程，所以没有特别说明情况下必须按时间由远及近的顺序安装。
...
<td>{{el.content}}</td>
<td width="100">{{parseFloat(el.length/1000).toFixed(2)}}</td>
