...
List<List<Object>> list=com.lingx.core.utils.ExcelUtils.readList(filepath);
int index=0;
...
<td align="center" >
	...
	if(list!=null&&list.size()>0){
		List<Object> listField=list.get(0);
		
		for(Object obj:listField){
			%>
	<tr>
	<td><%= ++index %></td>
	<td><input id='name_<%= index %>' class='name' value='<%= obj %>'/></td>
	<td><select id='value_<%= index %>' ><option>文本</option><option>数字</option><option>金额</option></select></td>
