...
import com.lingx.jt808.core.utils.FenceUtils;
...
public class FenceRule implements IJT808Rule{
	...
	public static List<FenceBean> getFenceBeans(List<Map<String,Object>> listTemp1){
	 ...
	 * @return
	 */
	public static boolean inFence(Point point,FenceBean bean) {
		boolean b=false;
		switch(bean.getType()) {
		case 1://面
