...
import com.lingx.jt808.core.bean.Cmd8302Bean;
...
public class Cmd8302 extends AbstractJT808Command {
	...
	public Cmd8302(String tid,int mark,String question,Cmd8302Bean answers[]) {
		super(0x8302, tid,getBody(mark,question,answers));
	}
