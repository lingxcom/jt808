...
public class Cmd8801 extends AbstractJT808Command {
	public Cmd8801(String tid,int tdh) {
		this(tid,tdh,1,3,0,4,5,0,0,0,0);
	}
	/**
	 * 起始字节 字段 数据类型 描述及要求 
0 通道 ID BYTE >0 
...
终端若不支持系统要求的分辨率，则取最接近的分辨率拍摄并上
	 ...
	 * @param p10
	 */
	public Cmd8801(String tid,int p1,int p2,int p3,int p4,int p5,int p6,int p7,int p8,int p9,int p10) {
		super(0x8801, tid,getBody(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10));
	}
